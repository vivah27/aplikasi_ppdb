        ...
        <div class="card-wrapper">
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <div class="card-header-sub">PPDB Tahun Ajaran <?php echo e($pendaftaran->tahun_ajaran ?? '-'); ?>/<?php echo e(intval($pendaftaran->tahun_ajaran) + 1 ?? '-'); ?></div>
                </div>
                    ...
                    <div class="info-group">
                        <div class="info-row">
                            ...
                            <div class="info-field">
                                ...
                                <div class="info-value"><?php echo e($siswa->tanggal_lahir ? \Carbon\Carbon::parse($siswa->tanggal_lahir)->format('d/m/Y') : '-'); ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="info-group">
                        <div class="info-field full-width">
                            ...
                            <div class="info-value">
                                <?php if($jurusan && $jurusan->nama_jurusan): ?>
                                    <?php echo e($jurusan->nama_jurusan); ?>

                                <?php elseif($jurusan && $jurusan->nama): ?>
                ...
                <div class="card-footer">
                    <div class="footer-item"><strong><?php echo e(config('app.name', 'PPDB')); ?></strong></div>
                    <div class="footer-item">Berlaku untuk keperluan resmi PPDB</div>
                    <div class="footer-item">Dicetak: <?php echo e(now()->format('d F Y')); ?></div>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\ppdb_denico_09\resources\views/cetak/kartu-peserta-template.blade.php ENDPATH**/ ?>