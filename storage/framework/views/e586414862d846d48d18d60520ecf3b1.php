...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="asal_sekolah" id="asal_sekolah" value="<?php echo e(old('asal_sekolah', $biodata->asal_sekolah ?? $siswa->asal_sekolah ?? '')); ?>" <?php echo e($isSubmitted ? 'readonly' : 'required'); ?> pattern="[A-Za-z0-9\s]+" maxlength="255">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control" name="tahun_lulus" id="tahun_lulus" value="<?php echo e(old('tahun_lulus', $biodata->tahun_lulus ?? '')); ?>" placeholder="Contoh: 2025" min="1900" max="2030" <?php echo e($isSubmitted ? 'readonly' : 'required'); ?>>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC_\aplikasi_ppdb\resources\views/user/biodata.blade.php ENDPATH**/ ?>