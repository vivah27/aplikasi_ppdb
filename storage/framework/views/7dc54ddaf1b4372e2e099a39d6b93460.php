    ...
    <?php if($pendaftaran): ?>
        ...
        <?php elseif($statusLabel === 'Diterima'): ?>
            <div class="status-card" style="border-left: 4px solid #10b981;">
                ...
                <a href="<?php echo e(route('cetak.kartu', $pendaftaran->id)); ?>" class="btn btn-primary">Cetak Kartu Kelulusan</a>
            </div>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\aplikasi_ppdb\resources\views/user/status.blade.php ENDPATH**/ ?>