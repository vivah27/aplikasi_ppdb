...
<?php $__env->startSection('page_title', 'Edit Gelombang'); ?>
...
<div class="container-fluid px-4">
    ...
    <div class="card shadow-sm">
        <div class="card-body p-4">
            <form action="<?php echo e(route('admin.gelombang.update', $gelombang)); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                               placeholder="Contoh: Gelombang 1" value="<?php echo e(old('nama_gelombang', $gelombang->nama_gelombang)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                               placeholder="Contoh: 1" value="<?php echo e(old('nomor_gelombang', $gelombang->nomor_gelombang)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('tanggal_buka', $gelombang->tanggal_buka->format('Y-m-d\TH:i'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                               value="<?php echo e(old('tanggal_tutup', $gelombang->tanggal_tutup->format('Y-m-d\TH:i'))); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                               placeholder="Contoh: 50000000" value="<?php echo e(old('harga', $gelombang->harga)); ?>" min="0">
...
unset($__errorArgs, $__bag); ?>"
                               placeholder="Contoh: Uang Pendaftaran" value="<?php echo e(old('jenis_pembayaran', $gelombang->jenis_pembayaran)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                              placeholder="Masukkan informasi rekening bank" rows="3"><?php echo e(old('tujuan_rekening', $gelombang->tujuan_rekening)); ?></textarea>
                ...
                <div class="mb-4">
                    <div class="form-check">
                        <input type="checkbox" name="is_active" id="is_active" class="form-check-input" 
                               value="1" <?php echo e(old('is_active', $gelombang->is_active) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\ppdb_denico_09\resources\views/admin/gelombang/edit.blade.php ENDPATH**/ ?>