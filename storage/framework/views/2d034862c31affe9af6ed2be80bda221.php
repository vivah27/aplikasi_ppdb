                        ...
                        <tr style="border-bottom: 1px solid #f3f4f6; transition: all 0.3s;" onmouseover="this.style.background='#f9fafb'" onmouseout="this.style.background=''">
                            ...
                            <td style="padding: 15px;">
                                <div style="display: flex; gap: 8px;">
                                    ...
                                    <button type="button" class="btn-delete-swal" data-action="<?php echo e(route('admin.jenis-dokumen.destroy', $item->id)); ?>" data-csrf="<?php echo e(csrf_token()); ?>" data-related="<?php echo e($item->dokumen()->count()); ?>" style="padding: 8px 12px; background: linear-gradient(135deg, #ef4444 0%, #f87171 100%); color: white; border: none; border-radius: 6px; font-size: 12px; font-weight: 600; cursor: pointer; display: inline-flex; align-items: center; gap: 6px; transition: all 0.3s;">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\aplikasi_ppdb_2\resources\views/admin/jenis-dokumen/index.blade.php ENDPATH**/ ?>