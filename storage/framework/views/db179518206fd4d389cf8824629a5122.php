...
<?php $__env->startSection('page_title', 'Cetak Kuitansi Pembayaran'); ?>
...
<div class="container-fluid px-4">
    ...
    <?php if($pembayaranTerverifikasi->count() > 0): ?>
        <div class="row">
            <div class="col-12">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-hover">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $pembayaranTerverifikasi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pembayaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td><?php echo e($index + 1); ?></td>
                                            <td><?php echo e($pembayaran->updated_at->format('d M Y H:i')); ?></td>
                                            <td>
                                                <?php if($pembayaran->metodePembayaran): ?>
                                                    <?php echo e($pembayaran->metodePembayaran->label); ?>

                                                <?php else: ?>
                                                    <?php echo e($pembayaran->metode); ?>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="<?php echo e(route('cetak.kuitansi', $pembayaran->id)); ?>"
                                                       target="_blank"
                                                       class="btn btn-primary btn-sm">
                                                        <i class="fas fa-print me-1"></i>Cetak
                                                    </a>
                                                    <a href="<?php echo e(route('cetak.kuitansi', $pembayaran->id)); ?>"
                                                       download="kuitansi-<?php echo e($pembayaran->id); ?>.html"
                ...
                <div class="card shadow-sm">
                    <div class="card-body text-center py-5">
                        ...
                        <div class="d-flex justify-content-center gap-3">
                            <a href="<?php echo e(route('user.pembayaran.index')); ?>" class="btn btn-primary">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\PC_\ifa\resources\views/cetak/kuitansi.blade.php ENDPATH**/ ?>