    ...
    <div class="card my-5">
            ...
            <div class="card-body">
                <div class="mb-4">
                    ...
                    @else
                        <div class="alert alert-info alert-dismissible fade show" role="alert">
                            ℹ️ Kami telah mengirimkan kode verifikasi (OTP) ke <strong>{{ session('verify_email') }}</strong>
                            <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                        </div>
                    @endif
                ...
                <div class="alert alert-light mt-4 border" role="alert">
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <form action="{{ route('send.otp') }}" method="POST" id="resendForm" style="display: inline;">
                            @csrf
        ...
        @else
            <div class="card-body text-center py-5">
                ...
                {{-- Bantuan untuk yang sudah terdaftar --}}
                <div class="alert alert-info mt-4" role="alert">
                    <strong>Sudah punya akun tapi belum verifikasi?</strong><br>
                    <small>Hubungi admin atau <a href="{{ route('send.otp.get') }}" class="btn btn-link btn-sm p-0">klik di sini untuk kirim ulang OTP</a></small>
                </div>
            </div>
        @endif
    </div>
