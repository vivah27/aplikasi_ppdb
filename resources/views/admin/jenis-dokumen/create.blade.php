...
<div class="form-header">
    <h1>Tambah Jenis Dokumen Baru</h1>
    <p>Buat kategori dokumen baru untuk sistem verifikasi</p>
</div>
    ...
    <form action="{{ route('admin.jenis-dokumen.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <textarea id="deskripsi" name="deskripsi" rows="5"
                      placeholder="Jelaskan jenis dokumen ini dan apa yang harus disertakan"
