...
<div class="stats-grid">
    <div class="stat-card">
        ...
        <div class="stat-value">{{ $dokumen->total() ?? 0 }}</div>
    </div>
    ...
    <div class="stat-card warning">
        ...
        <div class="stat-value">{{ $dokumen->filter(function($d) { return !$d->status_verifikasi_id; })->count() ?? 0 }}</div>
    </div>
                    ...
                    <tbody>
                        @foreach($dokumen as $item)
                            <tr>
                                ...
                                <td>
                                    <strong>{{ $item->jenisDokumen->nama ?? 'N/A' }}</strong>
                                </td>
                                <td>
                                    @php
                                ...
                                <td>
                                    @if($item->catatan)
                                        <small>{{ Str::limit($item->catatan, 30) }}</small>
                                    @else
