    ...
    <div class="container">
        ...
        <div class="receipt-number">
            <div class="receipt-number-left">
                <strong>No. Kuitansi:</strong> {{ $pembayaran->id }}/{{ now()->year }}
            </div>
        ...
        <div class="section">
            ...
            <div class="info-row">
                ...
                <div class="info-value">{{ $pembayaran->pendaftaran->tahun_ajaran ?? '-' }}</div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <div class="total-section">
                <div class="total-row">
                    ...
                    <div class="total-value">Rp {{ number_format($pembayaran->jumlah, 0, ',', '.') }}</div>
                </div>
            </div>
        </div>
